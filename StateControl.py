...
class StateController:
    ...
    def __init__(self, debug=False):
        ...
        self.rotate_delay = delay(0.2)  # pause between rotation and looking while searching
    ...
    def grab_ice(self, frame, suppress_exception = False):
        ...
        if self.debug and not self.is_debug_ignore_state():
            ...
            roi = frame[90:180, 0:70]
            cv.rectangle(frame,(0, 90),(70,180), (255, 0, 0), 3)
            try:
